...
var deleteCmd = &cobra.Command{
	Use:   "delete role|tenant|permission ID",
	Short: "Delete a resource given its type and id",
	Long:  "Delete a resource by id, specifically a role, tenant or permission.",
	Example: `
...
warrant delete permission perm-1`,
	Args: func(cmd *cobra.Command, args []string) error {
		...
		entityType := args[0]
		if entityType != "role" && entityType != "tenant" && entityType != "permission" {
			return fmt.Errorf("entity to delete must be a role|tenant|permission")
		}
		return nil
	},
